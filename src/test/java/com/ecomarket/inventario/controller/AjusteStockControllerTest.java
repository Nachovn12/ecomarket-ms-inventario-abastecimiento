...
@WebMvcTest(controllers = AjusteStockController.class, excludeFilters = @org.springframework.context.annotation.ComponentScan.Filter(type = org.springframework.context.annotation.FilterType.ASSIGNABLE_TYPE, classes = com.ecomarket.inventario.security.JwtAuthenticationFilter.class))
